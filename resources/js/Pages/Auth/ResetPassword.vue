            ...
            <form class="default_form login bg-white" @submit.prevent="resetPassword">
                <div class="form_group password_from_group input_active pb_20">
                    ...
                    <div class="position-relative">
                        <input id="password" class="input_grey pt_12 pb_12 pl_15 pr_50 round12 greybg w-100" placeholder="Enter your password" v-model="resetPasswordForm.password" :type="showPassword ? 'text' : 'password'">
                ...
                <div class="form_group password_from_group input_active pb_20">
                    ...
                    <div class="position-relative">
                        <input id="confirm-password" class="input_grey pt_12 pb_12 pl_15 pr_50 round12 greybg w-100" placeholder="Confirm your password" v-model="resetPasswordForm.confirm_password" :type="showConfirmPassword ? 'text' : 'password'">
                ...
                <button type="submit" class="btn btn-lg blue_button w-100" :disabled="!checkPasswordIsValidated">Reset</button>
            </form>
