<template>
    ...
    <div class="default_area">
        <div class="default_wrap">
            ...
            <form class="default_form login bg-white" @submit.prevent="register">
                <div class="form_group mb_20">
                    <label for="username" class="text_blue text_sm pb_8">Username</label>
                    <input id="username" type="text" class="input_grey pt_12 pb_12 pl_15 pr_15 round12 greybg w-100" placeholder="Enter your username" autocomplete="username" v-model="registrationForm.username">
                </div>
                ...
                <div class="form_group mb_20">
                    ...
                    <input id="email" type="text" class="input_grey pt_12 pb_12 pl_15 pr_15 round12 greybg w-100" placeholder="Enter your email address" autocomplete="email" v-model="registrationForm.email">
                </div>
                ...
                <div class="form_group mb_20">
                    ...
                    <Datepicker id="date_of_birth" class="input_grey pt_12 pb_12 pl_15 pr_15 round12 greybg w-100" placeholder="Select your date of birth"  v-model="registrationForm.date_of_birth" starting-view="year"></Datepicker>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb_20">
                        <div class="form_group">
                            <label for="first_name" class="text_blue text_sm pb_8">First Name</label>
                            <input id="first_name" type="text" class="input_grey pt_12 pb_12 pl_15 pr_15 round12 greybg w-100" placeholder="Enter your first name" autocomplete="first_name" v-model="registrationForm.first_name">
                        </div>
                    </div>
                    <div class="col-md-6 mb_20">
                        <div class="form_group">
                            <label for="last_name" class="text_blue text_sm pb_8">Last Name</label>
                            <input id="last_name" type="text" class="input_grey pt_12 pb_12 pl_15 pr_15 round12 greybg w-100" placeholder="Enter your last name" v-model="registrationForm.last_name">
                        </div>
                    </div>
                    <div class="col-md-12">
                ...
                <div class="form_group mb_20">
                    <label for="country" class="text_blue text_sm pb_8">Country</label>
                ...
                <div class="form_group mb_20" v-if="registrationForm.country && cities.length > 0">
                    <label for="city" class="text_blue text_sm pb_8">City</label>
                    <v-select id="city" label="name" :options="cities" v-model="registrationForm.city"></v-select>
                </div>

                <div class="form_group mb_20">
                    <label for="gender" class="text_blue text_sm pb_8">Gender</label>
                ...
                <div class="form_group mb_20">
                    <label for="sex" class="text_blue text_sm pb_8">Sex</label>
                ...
                <div class="form_group password_from_group input_active pb_20">
                    ...
                    <div class="position-relative">
                        <input id="password" class="input_grey pt_12 pb_12 pl_15 pr_50 round12 greybg w-100" placeholder="Enter your password" v-model="registrationForm.password" :type="showPassword ? 'text' : 'password'">
                ...
                <div class="form_group password_from_group input_active pb_20">
                    <label for="confirm-password" class="text_blue text_sm pb_8">Confirm Password</label>
                    <div class="position-relative">
                        <input id="confirm-password" class="input_grey pt_12 pb_12 pl_15 pr_50 round12 greybg w-100" placeholder="Confirm your password" v-model="registrationForm.confirm_password" :type="showConfirmPassword ? 'text' : 'password'">
                        <button type="button" class="password_eye position-absolute" style="right: 10px; top: 50%; transform: translateY(-50%); width: 30px; height: 30px; background: transparent; border: none;" @click="toggleShowConfirmPassword">
                            <img src="/images/eye.svg" class="eye" alt="eye" style="width: 20px; height: 20px;">
                        </button>
                    </div>
                </div>
                ...
                <div class="form_group password_from_group input_active mb_32">
                    <div class="password_strength_check mt-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <div class="psc_left d-flex">
                                <span class="strength_step strength_step1" :class="{ active: validatedRuleCount >= 1 }"></span>
                                <span class="strength_step strength_step2" :class="{ active: validatedRuleCount >= 2 }"></span>
                                <span class="strength_step strength_step3" :class="{ active: validatedRuleCount >= 3 }"></span>
                                <span class="strength_step strength_step4" :class="{ active: validatedRuleCount >= 4 }"></span>
                                <span class="strength_step strength_step5" :class="{ active: validatedRuleCount >= 5 }"></span>
                                <span class="strength_step strength_step5" :class="{ active: validatedRuleCount >= 6 }"></span>
                            </div>
                        </div>
                        <div id="password-rules-section" v-if="registrationForm.password.length > 0 && !checkPasswordIsValidated">
                            <p class="text_sm mb-2 fw-bold">Password Requirements:</p>
                            <ul class="text_sm pl-3 mb-0 list-unstyled">
                ...
                <button type="submit" class="blue_button w-100">Register</button>

                <p class="text-center text_sm f_500 mt_12 text_form_bottom">
                    <span class="text_bodyColor50">By signing up, you agree to our <Link href="/registration/rules" class="site_icon text_blue">Terms of Use</Link> and <br>
                        <Link href="/registration/privacy-policy" class="site_icon text_blue">Privacy Policy</Link>
                    </span>
                </p>
            </form>
