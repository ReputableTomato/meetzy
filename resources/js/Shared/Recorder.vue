<template>
    <div>
        <button type="button" class="site_icon border_left" @click="startRecording" v-if="!isRecording">
            <img src="/images/start-recording.svg" class="icon18" alt="microphone">
        </button>
        <button type="button" class="site_icon border_left" @click="stopRecording" v-if="isRecording">
            <img src="/images/stop-recording.svg" class="icon18" alt="microphone">
        </button>
    </div>
</template>
