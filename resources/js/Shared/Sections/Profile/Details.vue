<template>
    <div :class="['section_wrapper']" :style="'background-color: ' + user.profile.user_info_background_colour + '!important'">
        <!-- profile_top -->
		<div class="row mb-4 mt-2 align-items-center">
			<!-- Profile Picture -->
			<div class="col-12 col-sm-4 col-md-2 text-center">
				<div class="profile_top">
					<a href="#" class="profile_img profile_img_100 position-relative me-3 mb-3 mb-md-0 d-inline-block">
						<img :src="profile.profile_picture.url" alt="admin_img" class="rounded-circle img-fluid">
			...
			<div class="col-6 col-md-2 text-center">
				<h4 class="title16 text_blue" :style="'color: ' + user.profile.user_info_text_colour + '!important'">{{ profile.first_name }}</h4>
				<p class="text_sm text_bodyColor50">Name</p>
			</div>
			<!-- Username -->
			<div class="col-6 col-md-2 text-center">
				<h4 class="title16 text_blue" :style="'color: ' + user.profile.user_info_text_colour + '!important'">@{{ profile.username }}</h4>
				<p class="text_sm text_bodyColor50">Username</p>
			</div>
			<!-- Age -->
			<div class="col-6 col-md-2 text-center">
				<h4 class="title16 text_blue" :style="'color: ' + user.profile.user_info_text_colour + '!important'">{{ profile.age }}</h4>
				<p class="text_sm text_bodyColor50">Age</p>
			</div>
			<!-- Gender -->
			<div class="col-6 col-md-2 text-center">
				<h4 class="title16 text_blue" :style="'color: ' + user.profile.user_info_text_colour + '!important'">{{ profile.sex?.name }}</h4>
				<p class="text_sm text_bodyColor50">Gender</p>
			</div>
			<!-- Hometown -->
			<div class="col-6 col-md-2 text-center">
				<h4 class="title16 text_blue" :style="'color: ' + user.profile.user_info_text_colour + '!important'">{{ profile.city?.name }}</h4>
				<p class="text_sm text_bodyColor50">Hometown</p>
			</div>
		</div>

		<div class="row">
            <div class="col-12">
                <label for="email" class="text_blue text_sm pb_8" :style="'color: ' + user.profile.user_info_text_colour + '!important'">Spoken Languages</label>
                <v-select id="languages" label="name" :options="languages" v-model="profile.languages" v-if="editing" multiple></v-select>

                <div class="select_options d-flex align-items-center gap_8" v-if="!editing">
                    <button type="button" class="language_tag d-flex align-items-center" v-for="language in profile.languages" :key="language.id">
                        <p class="text_xsm">{{ language.name }}</p>
                    </button>
                </div>
            </div>
            <div class="col-12">
                <label for="email" class="text_blue text_sm pb_8" :style="'color: ' + user.profile.user_info_text_colour + '!important'">Interests</label>
                <v-select id="interests" label="name" :options="interests" v-model="profile.interests" v-if="editing" multiple></v-select>

                <div class="select_options d-flex align-items-center gap_8" v-if="!editing">
                    <button type="button" class="language_tag d-flex align-items-center" v-for="interest in profile.interests" :key="interest.id">
                        <p class="text_xsm">{{ interest.name }}</p>
                    </button>
                </div>
            </div>
            <div class="col-12">
                <label for="email" class="text_blue text_sm pb_8" :style="'color: ' + user.profile.user_info_text_colour + '!important'">About me </label>
			...
			<div class="col-12" v-if="editing">
				<div class="row">
					<div class="col-3">
						<div class="mb-3">
							<label for="user-info-background-colour" class="text_blue form-label h5">Background Colour</label>
					...
					<div class="col-3">
						<div class="mb-3">
							<label for="user-info-text-colour" class="text_blue form-label h5">Text Colour</label>
					...
					<div class="col-3">
						<div class="mb-3">
							<label for="about-me-background-colour" class="text_blue form-label h5">About Me Colour</label>
            ...
            <div class="col-12 d-flex justify-content-end">
				...
				<button type="button" class="btn main-button btn-lg me-3" @click="resetStyle" v-if="editing">Reset</button>
				<button type="button" class="btn main-button btn-lg" v-if="editing">Save</button>
            </div>
        </div>
    </div>

	<div class="section_wrapper mt-4">
		...
		<div class="wall_comments">
			<div class="comment_box">
				<div class="default_post_wrap" v-for="comment in comments.data" v-if="comments">
					<div class="comment_text">
						<div class="default_comment d-flex gap_x_12 border_t1 p_12 round12" :class="{ default_comment_post: comment.user.id === user.id }">
							<div href="#" class="profile_img profile_img_48 mr_10">
								<img :src="comment.user.profile_picture.url" alt="Avatar9">
							</div>
							<div class="default_comment_texts w-100">
								<div class="d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center">
										<a href="#" class="text_15 f_700 site_icon">{{ comment.user.first_name }}</a>
										<p class="text_bodyColor50 text_xsm f_400 pl_5"> {{ comment.user.age }} . </p>
									</div>
									<p class="text_bodyColor50 text_xsm f_500" :title="comment.created_at_title">{{ comment.created_at_display }}</p>
								</div>
								<p class="text_15 f_400 pb_8 pt_8" v-html="comment.content"></p>
				...
				<div class="default_post_wrap" v-if="comments.total === 0">
