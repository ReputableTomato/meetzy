<template>
    <div class="upload_content audio_upload d-flex align-items-center justify-content-between" :class="containerClasses ? containerClasses : ''">
        ...
        <div class="audio_upload_right d-flex align-items-center gap_x_6">
            <button type="button" class="site_icon" id="play-icon" @click="togglePlayPause" v-if="playState === 'play'">
                <img src="/images/play-button.svg" class="icon16" alt="play">
            </button>
            <button type="button" class="site_icon" id="play-icon" @click="togglePlayPause" v-if="playState === 'pause'">
                <img src="/images/pause-button.svg" class="icon16" alt="pause">
            </button>
            <button type="button" class="site_icon" v-if="!isEmbedded">
