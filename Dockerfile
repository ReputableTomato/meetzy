...
FROM gitlab.restricted.digital:5050/johnj/meetzy/build/meetzy_backend:latest as meetzy_base
...
FROM gitlab.restricted.digital:5050/johnj/meetzy/build/meetzy_frontend:latest as meetzy_frontend
